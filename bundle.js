(function (d3, topojson) {
      ...
      Promise
        ...
        .then(([covidData, topoJSONdata]) => {
          ...
          const featuresWithCovidCase=countries.features
            .filter(d=>d.properties['31122020'])
              .map(d=>{
                d.properties['31122020'] = d.properties['31122020'];
                  return d;
          });
    ...
    const radiusValue = d => d.properties['31122020'];
    ...
    loadAndProcessData().then(countries => {
      ...
      g.selectAll('path').data(countries.features)
        .enter().append('path')
          ...
          .attr('fill', d => d.properties['31122020'] ? '#d8d8d8' : '#fec1c1')
        .append('title')
